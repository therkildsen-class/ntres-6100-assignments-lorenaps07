...
Answer: *The parts that are different are the years, so you have buoy_1987, 1988, 1989, 1990. The rest of the code is basically the same, so it looks for the data for the named year in the same dataset.*
